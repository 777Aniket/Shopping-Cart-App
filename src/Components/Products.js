...
const Products = ({ post }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in-out shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]  gap-3 p-4 mt-10 rounded-xl">
      <div>
